...
<html lang="en">
    ...
    <body>
        <nav class="navbar navbar-expand-sm navbar-dark bg-info">
            <div class="container">
                <a class="navbar-brand" href="#">CodeIgniter <?php echo CI_VERSION; ?></a>
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavId">
                    <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="javascript:void(0)" onclick="mytablequery()">Tables With SQL JOIN</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <hr/>
            <center>
                ...
                <a href="javascript:void(0);">Codekop</a> © <?php echo date('Y');?>
            </center>
        <br/>
        ...
        <script>
            function mytable() {
                $('#tampil').load('<?php echo site_url("datatables/onetable");?>');
            }

            function mytablewhere() {
                $('#tampil').load('<?php echo site_url("datatables/tablewhere");?>');
            }

            function mytablequery() {
                $('#tampil').load('<?php echo site_url("datatables/tablequery");?>');
            }
